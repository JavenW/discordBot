module.exports = {
    ...
    execute(message, args, queue, teamA, teamB, userMap, role, roleMap) {
        if(args[1] && (args[1]==='jg' || args[1]==='mid' || args[1]==='top' || args[1]==='adc' || args[1]==='sup')){
            ...
            if(userMap.has(presetUser) && userMap.has(author)) {
                ...
                if(author != presetUser){
                    coin = userMap.get(author)-2;
                }else{
                    coin = userMap.get(author)-1;
                }
                if(coin<0){
                ...
                return message.reply("Preset @"+ message.guild.member(presetUser).nickname +" into " + args[1]);
            }else {
